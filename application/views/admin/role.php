                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" data-toggle="modal" data-target="#modalEdit<?= $r['id']; ?>" class=" badge 
                                    badge-primary" data-popup="tooltip" data-placement="top" title="Edit Data">
                                    <i class="fa fa-fw fa-pencil-alt"></i>Edit</a>
                                <a href="<?= base_url('admin/delete/') ?><?= $r['id']; ?>" class="badge badge-danger tombol" id="delete" name="delete">
...
<?php foreach ($role as $row) : ?>
    <div class="modal fade" id="modalEdit<?= $row['id'] ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-label">Edit Role</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
