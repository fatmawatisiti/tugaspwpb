                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#modalEdit<?= $sm['id']; ?>" class=" badge 
                                    badge-primary" data-popup="tooltip" data-placement="top" title="Edit Data">
                                    <i class="fa fa-fw fa-pencil-alt"></i>Edit</a>
                                <a href="<?= base_url('menu/deleteSubMenu/') ?><?= $sm['id']; ?>" class="badge badge-danger tombol" id="delete" name="delete">
...
<?php foreach ($subMenu as $row) : ?>
    <div class="modal fade" id="modalEdit<?= $row['id'] ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-label">Edit Submenu</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
